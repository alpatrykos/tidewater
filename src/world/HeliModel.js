...
export const HELI = {
	...
	eye: new Vector3( 0, 1.72, - 0.42 ), // pilot's eyes
...
export class HeliModel {
	...
	constructor() {
		...
		add( rod( v( 0, 0.62, - 0.72 ), v( 0, 1.18, - 0.78 ), 0.014, 8 ), dark );
		add( roundedBox( 0.05, 0.12, 0.05, 0.02 ), { ...black, matrix: mat4( 0, 1.22, - 0.79 ) } );
